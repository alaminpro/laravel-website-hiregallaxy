...
edit company details | {{ App\Models\Setting::first()->site_title }}
                            ...
                            <form action="{{ route('company.update', $edit->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="assign_id" id="assign_id" class="form-control" value="{{ old('assign_id') }}" required>
                                        ...
                                        <option value="{{ $user->id }}" {{ $user->id == $edit->assign_id ? 'selected' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" minlength="5" placeholder="Write Your Company Name" required  value="{{$edit->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="contact_person">Contact Person <span class="required">*</span></label>
                                    <input type="text" minlength="5" class="form-control" name="contact_person" id="contact_person" placeholder="Contact Person Name" required  value="{{$edit->contact_person }}">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email Address <span class="required">*</span></label>
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Write Your Email Address" required  value="{{$edit->email }}">
                                </div>
                                <div class="form-group">
                                    <label for="location">Location </label>
                                    <select name="location" id="location" class="form-control" value="{{$edit->location }}">
                                        ...
                                        <option value="{{ $country->id }}" {{ $edit->location == $country->id ? 'selected':'' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="tel" class="form-control" name="phone"   id="telephone"  value="{{$edit->phone }}"  required >
                                    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control" name="website_url" id="website_url"  value="{{$edit->website_url }}">
                                </div>
                                <div class="form-group">
