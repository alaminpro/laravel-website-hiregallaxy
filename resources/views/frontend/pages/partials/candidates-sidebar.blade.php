<div class="employer-detail-sidebar">
	...
	<div class="single-job-description mt-2">
		<h3>{{ $user->name }}</h3>
		<p class="text-yellow mb-3"> {{ $user->candidate->sector_data->name }}</p>
	</div>
	<div class="user-sidebar">
		<div class="list-group">
			...
			<a href="{{ route('candidates.messages') }}" class="list-group-item list-group-item-action {{ Route::is('candidates.messages') ? 'active' : '' }}">
