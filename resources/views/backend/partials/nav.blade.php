      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="" action="{{ route('admin.password.change') }}" method="post">
              ...
              <input type="text" name="password" id="password" placeholder="New Password" class="form-control" required/>

              <br>

              <input type="text" name="password_confirmation" id="password_confirmation" placeholder="Confirm Password" class="form-control" required/>
