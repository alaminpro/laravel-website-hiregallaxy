            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ route('candidates.show', $user->username) }}" target="_blank"><i class="fa fa-link"></i> {{ route('candidates.show', $user->username) }}</a>
                ...
                <td>
                  ...
                  @if ($user->status == 2 || $user->status == 0)
                     ...
                     <button class="btn btn-circle btn-outline-success" data-toggle="modal" data-target="#deleteModal{{ $user->id }}" title="Active Candidate"><i class="fa fa-fw fa-check"></i></button>

                  @endif

                 @if ($user->status == 1)

                     <button class="btn btn-circle btn-outline-danger" data-toggle="modal" data-target="#deleteModal{{ $user->id }}" title="Ban Candidate"><i class="fa fa-fw fa-ban"></i></button>
                    ...
                    <div class="modal-dialog" role="document">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h5 class="modal-title" id="exampleModalLabel">Are you sure want to {{ ($user->status == 2 || $user->status == 0) ? 'active' : 'ban' }} this candidate ?</h5>
                        ...
                        <div class="modal-body">Please confirm if you want to {{ ($user->status == 2 || $user->status == 0) ? 'active' : 'ban' }} the Candidate</div>
