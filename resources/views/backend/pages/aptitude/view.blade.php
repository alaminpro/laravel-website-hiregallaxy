    ...
    <div class="card mb-3">
      <div class="card-header py-3">
        ...
        <div class="float-right">
          ...
          <a href="{{ route('admin.aptitude.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-angle-left fa-sm text-white-50"></i> Back</a>
        </div>
        <div class="clearfix"></div>
      </div>
      <div class="card-body">
