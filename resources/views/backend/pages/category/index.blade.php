    ...
    <div class="card mb-3">
      <div class="card-header py-3">
        ...
        <div class="float-right">
          @if (Route::is('admin.category.index'))
          ...
          @elseif(Route::is('admin.category.trash'))
          ...
          <a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal"
            data-target="#addModal"><i class="fas fa-plus-circle fa-sm text-white-50"></i> Add New Position</a>
        </div>
        <div class="clearfix"></div>
      </div>
      <div class="card-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {{ $category->name }}
                  <br>
                  <a href="{{ route('jobs.categories.show', $category->slug) }}" target="_blank"><i
                ...
                <td>
                  ...
                  <a href="#editModal{{ $category->id }}" class="btn btn-circle btn-outline-success"
                    title="Edit Position" data-toggle="modal"><i class="fa fa-edit"></i></a>
                  @endif


                  @if ($category->status == 0)
                  <a href="#activeModal{{ $category->id }}" class="btn btn-circle btn-outline-success"
                    title="Activate Position" data-toggle="modal"><i class="fa fa-check"></i></a>
                  @endif


                  <button class="btn btn-circle btn-outline-danger" data-toggle="modal"
                    data-target="#deleteModal{{ $category->id }}" title="Delete Position"><i
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Are you sure want to delete this category ?
                          </h5>
                  ...
                  <!-- Activate Modal -->
                  <div class="modal fade" id="activeModal{{ $category->id }}" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Are you sure want to activate this category ?
                          </h5>
                          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                          </button>
                        ...
                        <div class="modal-footer">
                          <button class="btn btn-outline-secondary btn-sm" type="button"
                            data-dismiss="modal">Cancel</button>
                          <form class="" action="{{ route('admin.category.active', $category->id) }}" method="post">
                            @csrf
                            <button type="submit" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i>
                              Confirm</button>
                          </form>
                        ...
                        <div class="form-row">
                          ...
                          <div class="col-md-4 form-group">
                            ...
                            <select name="parent_category_id" id="parent_category_id" class="form-control">
                              <option value="">Select Parent category if you want</option>
                              @foreach ($parent_categories as $cat)
                              <option value="{{ $cat->id }}"
                                {{ $category->parent_category_id == $cat->id ? 'selected' : '' }}>{{ $cat->name }}
                              </option>
                              @endforeach
                        ...
                        <div class="form-row">
                          <div class="col-md-12 form-group">
                            ...
                            <textarea name="description" id="description" name="description" rows="8" cols="80"
                              class="tinymce form-control">{{ $category->description }}</textarea>
                          </div>
                        </div>
      ...
      <div class="modal-body">
        <form action="{!! route('admin.category.submit') !!}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <div class="col-md-4 form-group">
              <label for="is_featured">Is Featured <span class="text-info required">(optional)</span></label>
              <select name="is_featured" id="is_featured" class="form-control">
