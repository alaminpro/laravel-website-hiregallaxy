...
<div class="row">
	...
	<div class="col-xl-3 col-md-6 mb-4">
		<div class="card border-left-primary shadow pointer h-100 py-2"
			onclick="location.href='{{ route('admin.skill.index') }}'">
	<div class="card-body">
		<div class="row no-gutters align-items-center">
			<div class="col mr-2">
				<div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Skills</div>
				<div class="h5 mb-0 font-weight-bold text-gray-800">
					{{ ($skills) }}
				</div>
			</div>
...
{{--  <div class="col-xl-3 col-md-6 mb-4">
		<div class="card border-left-info shadow pointer h-100 py-2"
			onclick="location.href='{{ route('admin.experience.index') }}'">
<div class="card-body">
	<div class="row no-gutters align-items-center">
		<div class="col mr-2">
			<div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Experiences</div>
			<div class="h5 mb-0 font-weight-bold text-gray-800">
				{{ ($experiences) }}
			</div>
		</div>
...
<div class="col-xl-3 col-md-6 mb-4">
	<div class="card border-left-primary shadow pointer h-100 py-2"
		...
		<div class="card-body">
			<div class="row no-gutters align-items-center">
				<div class="col mr-2">
					<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Segments</div>
					<div class="h5 mb-0 font-weight-bold text-gray-800">
						{{ ($segments) }}
					</div>
				</div>
...
<!--<div class="col-xl-3 col-md-6 mb-4">-->
<!--	<div class="card border-left-warning shadow pointer h-100 py-2" onclick="location.href='{{ route('admin.experience.index') }}'">-->
<!--		<div class="card-body">-->
<!--		</div>-->
<!--	</div>-->
<!--</div> <!-- Single -->
