        ...
        <tbody>
            <tr style="background: #ededed;">
                <td style="vertical-align: top; padding-bottom:30px;" align="center"><a href="{{ route('index') }}" target="_blank">
                    <img src="https://i.ibb.co/8rfLQCt/devs-Env-Logo.gif" alt="Hire Gallaxy" style="border: none;width: 120px;">
                    <br>
                </td>
            </tr>
        </tbody>
    ...
    <div style="padding: 40px; background: #fff;">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    <td style="border-bottom:1px solid #f6f6f6;">
                        ...
                        <p style="margin-top: 5px;color: #000;">
                            Welcome to HireGallaxy | You are now a member of us. You can now see jobs, apply jobs, post jobs and many more...
                        </p>
                    </td>
                </tr>
                <tr>
            ...
            <p style="text-align: center; margin-top: 40px">
                ...
                Copyright © hiregallaxy, All rights reserved.
            </p>
        </div>
    </div>