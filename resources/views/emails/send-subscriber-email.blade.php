<div style="max-width: 700px;font-size: 14px; margin: 0px auto; box-shadow: 1px 10px 20px #80808061;">
        ...
        <tbody>
            <tr style="background: #ededed;">
                <td style="vertical-align: top; padding-bottom:30px;" align="center">
                    <a href="https://hiregallaxy.com" target="_blank">
                        <h2>Hire Gallaxy</h2>
                </td>
            </tr>
        </tbody>
    ...
    <div style="padding: 40px; background: #fff;">
            ...
            <tbody>
                <tr>
                    <td style="border-bottom:1px solid #f6f6f6;">
                        ...
                        <p style="margin-top: 5px;color: #000;">
                            Welcome to Hire Gallaxy | Here are our latest job posts if you missed it.
                        </p>
                    </td>
                </tr>
                ...
                <tr style="margin-top: 40px">
                    <td style="padding: 20px;background: #f5f5f5;margin-top: 0px;">
                        ...
                        <p>
                            Link:
                            <a href="https://hiregallaxy.com/jobs/view/{{  $job->slug }}">
                                View Job
                            </a>
                        </p>
                    </td>
                ...
                <tr>
                    <td style="border-top:1px solid #f6f6f6; padding-top:20px; color:#777">If the button above does not
                        ...
                        please feel free to contact us at <a href="https://hiregallaxy.com/contact-us">Contact us</a></td>
                </tr>
        ...
        <p style="text-align: center; margin-top: 10px">
            ...
            <a href="https://hiregallaxy.com/unsubscribe/" style="color: red; font-weight: bold">
                Unsubscribe Now
            </a>
        </p>
    </div>
