                        ...
                        <form action="{{ route('register') }}" method="post" data-parsley-validate="">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control username-check" name="username"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control email-check" name="email" id="email"
                                        placeholder="Write Your Email Address" required value="{{ old('email') }}"
                            ...
                            <div class="row justify-content-center form-group text-center">
                                ...
                                <div class="col-8">
                                    ...
                                    <input type="submit" value="Sign Up"
                                        class="btn btn-block apply-now-button pt-2 pb-2 font20 ">
                        ...
                        <form action="{{ route('register.employee') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" data-parsley-required-message="Please enter your username."
                                        data-parsley-minlength="5" class="form-control username-check" name="username"
                                        id="employe_username" placeholder="Write Your Username" required
                                        value="{{ old('username') }}">
                                    @if($errors->has('username'))
                                    <div class="text-danger">{{ $errors->first('username') }}</div>
                                    @endif
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control email-check" name="email" id="employe_email"
