$(function(){
    ...
    if(getQueryParams() === 'all' || getQueryParams() === 'new' || 
     getQueryParams() === 'shortlisted' || getQueryParams() === 'interview'|| getQueryParams() === 'offered' || getQueryParams() === 'hired' || getQueryParams() === 'rejected'){
