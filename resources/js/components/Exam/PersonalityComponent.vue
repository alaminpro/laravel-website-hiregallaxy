...
<div>
    ...
    <div v-if="exam_status" class="d-flex justify-content-center mt-5">
        <div class="hiregallaxy__start_exam py-5 d-flex flex-column align-items-center">
            <h1 class="text-danger text-center pb-2">You are Allreay Give Your personality Test!</h1>
    ...
    <div v-if="isExamStart" class="hiregallaxy_main__section d-flex flex-column justify-content-center  w-100">
        ...
        <div class="hiregallaxy_main__question d-flex justify-content-start align-items-center" v-if="!showResult">
            <div class="hiregallaxy_pagination__left_side d-flex  align-items-center">
                ...
                <h5 class="mb-0 mx-3 ">Total Questions: <span class="text-danger">{{quiz.questions.length}}</span></h5>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="hiregallaxy_left__side text-left">
                        ...
                        <p class="hiregallaxy__question m-0 font-weight-bold">{{questionIndex+1}}. <span class="question__image" v-html="quiz.questions[questionIndex].question"></span></p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="hiregallaxy_right__side mt-5 mt-lg-0">
                        ...
                        <div class="hiregallaxy__options">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="question" v-model="question" id="question_1" value="0">
                                <label class="form-check-label" for="question_1">
                                    {{ quiz.questions[questionIndex].answer_1 }}
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="question" v-model="question" id="question_2" value="1">
                                <label class="form-check-label" for="question_2">
                                    {{ quiz.questions[questionIndex].answer_2 }}
                                </label>
                            </div>
                        </div>
        ...
        <div class="hiregallaxy__submit_result d-flex justify-content-center my-5 py-5" v-if="showResult">
            <button @click="submitResult" class="btn btn-success">Submit & Go back</button>
        </div>
    </div>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        fetchData() {
            Axios.get('/candidates/personality/questions/' + this.id).then(async (res) => {
