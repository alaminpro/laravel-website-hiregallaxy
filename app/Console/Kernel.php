    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        foreach ($subscribed_users as $user) {
            if (count($jobs) > 0) {
                echo $user;
                $to = $user->email;
                $subject = 'Latest Job Posts From Hire Gallaxy';
                // $message = 'This mail is sent using the PHP mail function Test';
                // $headers = 'From: support@hiregallaxy.com';
                ...
                $headers[] = "To: User <$to>";
                $headers[] = 'From: Latest Job Posts | HireGallaxy <support@hiregallaxy.com>';
                    ...
                    <div>
                        <div style="background: #FFF;">
                            <div style="vertical-align: top;padding-bottom: 7px;margin-top: 0px;padding-top: 2px;" align="center">
                                <a href="https://hiregallaxy.com" target="_blank" style="text-decoration: none;font-weight: bold;font-family: monospace;font-size: 24px;">
                                    <img src="https://hiregallaxy.com/public/images/1568510871.png" style="max-width: 200px"/>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    $message .= '
                                  <div style="padding: 10px;margin-top: 10px;box-shadow: 3px 7px 17px 2px #3f51b51f;background: #cccccc2b;">
                                    ...
                                    . '</h3>
                                      ...
                                      '</p>
                                      <p>
                                          <a href="https://hiregallaxy.com/jobs/view/' . $job->slug . '" style="background: #5e59c9!important;padding: 5px 20px;color: #FFF;text-decoration: none;border-radius: 10px;font-weight: bold;">
                                              View Job
                                          </a>
                                      </p>
                                  </div>
                ...
                $message .= '
                      ...
                      If the button above does not
                          ...
                          please feel free to contact us at <a href="https://hiregallaxy.com/contact-us">Contact us</a>
                      </div>
                            
                    <p style="text-align: center; margin-top: 40px">
                        <a href="https://hiregallaxy.com">Visit our website</a> | Get Support
                        Copyright © Hire Gallaxy, All rights reserved.
                    </p>
                    <p style="text-align: center; margin-top: 10px">
                        Are you willing to unsubscribe from our news letter ?
                        <a href="https://hiregallaxy.com/unsubscribe/' . $to . '" style="color: red; font-weight: bold">
                            Unsubscribe Now
                        </a>
                    </p>
                </div>
